        ...
        <Col className="pass-fail-card">
            <Card className="pass-fail-results">
                <Card.Body className="widget-card-body">
                    <Card.Title className="widget-card-title">Total Pass %</Card.Title>
                    <Card.Text as="div">
                        <div>
            ...
            <Col className="env">
                <Card className="env-info">
                    <Card.Body className="env-card-body">
                        <Card.Title className="env-card-title">Environment</Card.Title>
                        <hr />
                        <Card.Text as="div" className="env-card-text">
                            <div className="env-card-body">
                                <EnvironmentDetails
                                    testName="sign_in_tests"
                                    date="05/01/2023 09:58"
                                    env="Staging"
                                    browser="Chrome"
                                    os="Mac"
                                    pass={85}
                                ...
                                ></EnvironmentDetails>
                                <EnvironmentDetails
                                    testName="new_user_tests"
                                    date="05/03/2023 12:41"
                                    env="Staging"
                                    browser="Chrome"
                                    os="Windows"
                                    pass={90}
...
function EnvironmentDetails(props) {
    return <Collapsible title={CollapsibleTitle(props)} content={CollapsibleContent(props)} />;
}

function CollapsibleTitle(props) {
    return (
        <Row sm="2" className="env-rows">
            <Col className="suite-name">{props.testName}</Col>
...
function Collapsible(props) {
    ...
    return (
        <div className="collapsible">
            <div className={headerName}>{isExpanded ? props.title : props.title}</div>
