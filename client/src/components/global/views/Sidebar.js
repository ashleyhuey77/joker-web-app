    ...
    return (
        <>
            <div id="navbar" className="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark">
                ...
                <SidebarContent className="sidebar-content"></SidebarContent>
...
export function SidebarHeader(props) {
    return (
        <>
            ...
            >
                <i id="header-icon" className={props.icon}></i>
    ...
    return (
        <>
            <ul className={'nav nav-pills flex-column mb-auto ' + props.className}>
                <SidebarMenuItem icon="fa-solid fa-gauge" title="dashboard">
                    Dashboard
                </SidebarMenuItem>
                <SidebarMenuItem icon="fa-solid fa-sitemap" title="suites">
                    Suites
                </SidebarMenuItem>
                <SidebarMenuItem icon="fa-solid fa-chart-line" title="metrics">
                    Metrics
                </SidebarMenuItem>
                <SidebarMenuItem icon="fa-solid fa-bugs" title="problems">
                    Problems
                </SidebarMenuItem>
            </ul>
        </>
    ...
    return (
        <li className="nav-item">
            <div className="nav-link text-white" aria-current="page">
                <i className={props.icon + ' sidebar-icons'}></i>
                <Link
...
export function SidebarFooter() {
    return (
        <>
            <hr />
            <div id="sidebar-footer">© 2023 Ash Huey</div>
        </>
    );
}
